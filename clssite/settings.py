"""
Django settings for clssite project.
...
SECRET_KEY = 'xgth+n6q+=pb*dk3!jqv-k=h158s2qp!yho2qvu99lyvjm%2e-'
...
WSGI_APPLICATION = 'clssite.wsgi.application'
